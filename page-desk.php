...
$wAccessCode = evalsplot_option('accesscode');
...
if ( 	isset( $_POST['evalsplot_form_access_submitted'] ) 
		&& wp_verify_nonce( $_POST['evalsplot_form_access_submitted'], 'evalsplot_form_access' ) ) {
	...
	if ( $wAccess != $wAccessCode ) $errors[] = '<p><strong>Incorrect Access Code</strong> - try again? Hint: ' . evalsplot_option('accesshint'); 	
				...
				<div class="post">
					...
					<?php else:?>
						...
						?>   
	 					...
	 					<form  id="evalsplotdesk" class="evalsplotdesk" method="post" action="">
								...
								<fieldset>
									<?php wp_nonce_field( 'evalsplot_form_access', 'evalsplot_form_access_submitted' ); ?>
